### Audio & Linux desktop
* [speaker-tuning-to-easyeffects](https://github.com/antoinecellerier/speaker-tuning-to-easyeffects) - Convert OEM laptop Dolby Atmos speaker tuning profiles into EasyEffects presets, so Linux gets the sound the hardware was tuned for.
...
* [les-aiguilles-blanches](https://github.com/antoinecellerier/les-aiguilles-blanches) - Snow groomer simulation game set in a fictional Savoie ski resort, in the retro SkiFree tradition. [Play in the browser](https://cellerier.net/les-aiguilles-blanches/).
